...
public:
    ...
    ~Zebra() {
        count--;
        cout << "Ugh! I'm dying! The current count is: " << count << endl;
    }
...
public:
    ZebraKid(string name) : Zebra(name){
...
static void f() {
    ...
    Zebra z1("Joker");
    Zebra z2("Alice");
    cout << "New count after creating two Zebras: " << Zebra::getCount() << endl;
}
